...
public class RemoteObjectRef {
	...
	Object localise() {
		...
		try {
			...
			InvocationHandler handler = new RORInvocationHandler((UserAdmin) o);
			UserAdmin proxy = (UserAdmin) Proxy.newProxyInstance(o.getClass().getClassLoader(), o.getClass().getInterfaces(), handler);
			return proxy;
