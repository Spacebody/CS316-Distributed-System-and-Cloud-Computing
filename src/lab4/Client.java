...
public class Client {
    ...
    public static void main(String[] args) throws RemoteException, Exception {
        ...
        while(choose!=3) {
            System.out.println("Welcome to the Topic subscription system.");
            ...
            switch (choose) {
                ...
                case 2: //case of login
                    ...
                    if(stub.login(username, password)) {
                        ...
                        actions.receive_new_messages(username); //receive new messages
                        actions.showMenu(username); //show menus for next actions
                    }else{
